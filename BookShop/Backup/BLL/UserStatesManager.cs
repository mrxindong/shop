...
namespace BookShop.BLL
{
	...
	/// </summary>
	public class UserStatesManager
	{
		private readonly BookShop.DAL.UserStatesServices dal=new BookShop.DAL.UserStatesServices();
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public BookShop.Model.UserStates GetModelByCache(int Id)
		{
			...
			return (BookShop.Model.UserStates)objModel;
		}
		...
		public List<BookShop.Model.UserStates> DataTableToList(DataTable dt)
		{
			...
			if (rowsCount > 0)
			{
				...
				{
					model = new BookShop.Model.UserStates();
