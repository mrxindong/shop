...
namespace BookShop.BLL
{
	...
	{
		private readonly BookShop.DAL.BooksServices dal=new BookShop.DAL.BooksServices();
		public BooksManager()
		{}
		#region  成员方法
		...
		/// 更新一条数据
		/// </summary>
		public void Update(BookShop.Model.Books model)
		{
			dal.Update(model);
		}
		...
		public List<BookShop.Model.Books> DataTableToList(DataTable dt)
		{
			...
			if (rowsCount > 0)
			{
				...
				{
					model = new BookShop.Model.Books();
