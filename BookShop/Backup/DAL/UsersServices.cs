...
namespace BookShop.DAL
{
	...
	public class UsersServices
	{
		...
		/// 更新一条数据
		/// </summary>
		public void Update(BookShop.Model.Users model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[7].Value = model.UserRoleId;
			parameters[8].Value = model.UserStateId;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,LoginId,LoginPwd,Name,Address,Phone,Mail,UserRoleId,UserStateId ");
