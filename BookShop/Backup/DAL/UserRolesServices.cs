...
namespace BookShop.DAL
{
	...
	public class UserRolesServices
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "UserRoles"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from UserRoles");
		...
		public void Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UserRoles ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
			parameters[0].Value = Id;
		...
		public BookShop.Model.UserRoles GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Name from UserRoles ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
			parameters[0].Value = Id;

			BookShop.Model.UserRoles model=new BookShop.Model.UserRoles();
