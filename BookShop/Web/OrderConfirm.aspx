<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OrderConfirm.aspx.cs" Inherits="BookShop.Web.OrderConfirm" %>
            ...
            <table datasrc="" cellspacing="0" cellpadding="1" width="98%" border="1">
              ...
              <ItemTemplate>
                <tr class="align_Center">
                  ...
                  <td><span class="price">￥<%#Eval("Book.UnitPrice","{0:0.00}") %></span></td>
                  <td><%#Eval("count") %></td>
