...
namespace BookShop.DAL
{
	...
	public class OrdersServices
	{
        ...
        //调用存储过程生成订单,返回总金额
        public decimal CreateOrder(string orderNumber,int userId,string address)
        {
            ...
            parameters[3].Direction = ParameterDirection.Output;//Direction默认是input,这里要返回数据,所以要改成Output
            DbHelperSQL.RunProcedure("usp_CreateOrder", parameters);
